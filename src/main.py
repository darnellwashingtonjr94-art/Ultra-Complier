...
from src.frontends import parse_file
from src.ir_core import generate_ir
from src.backends import generate_binary
from src.packagers import package_app


def main():
    if len(sys.argv) < 3:
        print("Error: Usage: python3 -m src.main <source_file> <target_format>")
        sys.exit(1)

    source_file = sys.argv[1]
    target_format = sys.argv[2]

    print(f"--- Ultra-Compiler Pipeline Started ---")
